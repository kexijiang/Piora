...
export function ApplicationBackupCard() {
  ...
  return <section className={styles.card}>
    <div className={styles.header}><div><h3>{zh ? "完整备份与迁移" : "Full backup and migration"}</h3><p>{zh ? "迁移模型配置与凭据、全部会话、随身仓、插件资源、应用设置、草稿、自定义背景和已下载语音包。" : "Move model configuration and credentials, all sessions, Pocket, plugin resources, settings, drafts, backgrounds and downloaded speech packs."}</p></div></div>
