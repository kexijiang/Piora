...
test("backup path remapping follows the destination syntax rather than the host platform", () => {
  const cases = [
    { value: "C:\\old\\uploads\\one.txt", from: "C:\\old", to: "/srv/new", expected: "/srv/new/uploads/one.txt" },
    { value: "/srv/old/uploads/one.txt", from: "/srv/old", to: "D:\\new", expected: "D:\\new\\uploads\\one.txt" },
    { value: "C:/OLD/uploads/one.txt", from: "c:\\old", to: "D:/new", expected: "D:\\new\\uploads\\one.txt" },
    { value: "C:\\old\\uploads\\one.txt", from: "C:\\old", to: "\\\\server\\share\\new", expected: "\\\\server\\share\\new\\uploads\\one.txt" },
    { value: "\\\\server\\share\\old\\uploads\\one.txt", from: "\\\\server\\share\\old", to: "/srv/new", expected: "/srv/new/uploads/one.txt" },
    { value: "/srv/old/uploads/one.txt", from: "/srv/old", to: "/srv/new", expected: "/srv/new/uploads/one.txt" },
    { value: "C:\\old", from: "C:\\old", to: "/srv/new", expected: "/srv/new" },
    { value: "C:\\old-other\\one.txt", from: "C:\\old", to: "/srv/new", expected: "C:\\old-other\\one.txt" },
    { value: "/srv/OLD/one.txt", from: "/srv/old", to: "/srv/new", expected: "/srv/OLD/one.txt" },
  ];
  for (const { value, from, to, expected } of cases) {
    assert.equal(backup.remapBackupPath(value, [{ from, to }]), expected, from + " -> " + to);
  }
  assert.equal(backup.remapBackupPath("C:\\old\\nested\\one.txt", [
    { from: "C:\\old", to: "/srv/outer" },
    { from: "C:\\old\\nested", to: "/srv/inner" },
  ]), "/srv/inner/one.txt");
});
