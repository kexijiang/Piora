...
test("packaged sharp decodes images under Electron using its complete native dependency sidecar", { timeout: 60_000 }, async (t) => {
  ...
  assert.ok(assets.some((asset) => asset.name.includes("@img/sharp-" + process.platform)));
