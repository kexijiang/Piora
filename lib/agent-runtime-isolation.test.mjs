...
test("ordinary sessions expose every first-party extension to the load plan", () => {
  assert.deepEqual(
    ...
    ["piora-automations.ts", "piora-browser.ts", "piora-computer.ts", "piora-file-changes.ts", "piora-goal.ts", "piora-harmony.ts", "piora-plan.ts", "piora-room.ts", "piora-vision-agent.ts"],
  );
});
