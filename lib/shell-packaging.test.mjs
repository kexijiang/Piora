...
test("packaged Electron Shell opens its SQLite worker and integration scripts outside ASAR", { skip: process.env.PIORA_SKIP_RESOURCE_TESTS === "1", timeout: 120000 }, async t => {
