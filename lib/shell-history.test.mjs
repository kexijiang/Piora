...
test("the history worker serves queries during large imports and drains records across chunk boundaries", { timeout: 90000 }, async t => {
  ...
  assert.ok(p95 < 100, `Import interfered with autocomplete: P95 ${p95.toFixed(1)}ms`);
